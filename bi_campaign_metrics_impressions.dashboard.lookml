- dashboard: bing_campaign_metrics_impressions
  ...
  - title: Impressions By Day Of Week
    ...
    y_axes: [{label: '', orientation: bottom, series: [{id: fact.total_impressions,
        ...
        tickDensity: default, type: linear, __FILE: app-marketing-bing-ads/bi_campaign_metrics_impressions.dashboard.lookml,
        __LINE_NUM: 257}]
  ...
  - title: Impressions By Device
    ...
    y_axes: [{label: '', orientation: bottom, series: [{id: fact.total_impressions,
            name: Impressions, axisId: fact.total_impressions, __FILE: app-marketing-bing-ads/bi_campaign_metrics_impressions.dashboard.lookml,
  ...
  - title: Impressions By Network
    ...
    show_view_names: true
    y_axes: [{label: '', orientation: bottom, series: [{id: fact.total_impressions,
            name: Fact Impressions, axisId: fact.total_impressions, __FILE: app-marketing-bing-ads/bi_campaign_metrics_impressions.dashboard.lookml,
            __LINE_NUM: 193}], showLabels: false, showValues: false, unpinAxis: false,
        tickDensity: default, type: linear, __FILE: app-marketing-bing-ads/bi_campaign_metrics_impressions.dashboard.lookml,
        __LINE_NUM: 190}]
    show_y_axis_labels: true
    show_y_axis_ticks: true
  ...
  - title: Landing Pages Impressions Change
    ...
    explore: bing_keyword_date_fact
    type: looker_bar
    fields: [ad_group.ad_group_name, campaign.campaign_name, keyword.final_url, last_fact.total_impressions_period_delta,
    ...
    y_axes: [{label: '', orientation: bottom, series: [{id: last_fact.total_impressions,
            name: Keyword Prior Period, axisId: last_fact.total_impressions, __FILE: app-marketing-bing-ads/bi_campaign_metrics_impressions.dashboard.lookml,
            __LINE_NUM: 610}, {id: fact.total_impressions, name: Keyword This Period,
            axisId: fact.total_impressions, __FILE: app-marketing-bing-ads/bi_campaign_metrics_impressions.dashboard.lookml,
  ...
  - title: Creative Impressions Change
    ...
    show_view_names: false
    y_axes: [{label: '', orientation: bottom, series: [{id: last_fact.total_impressions,
            name: Ad Last Period, axisId: last_fact.total_impressions, __FILE: app-marketing-bing-ads/bi_campaign_metrics_impressions.dashboard.lookml,
  ...
  - title: Ad Group Impressions Change
    ...
    show_view_names: false
    y_axes: [{label: '', orientation: bottom, series: [{id: last_fact.total_impressions,
            name: Ad Group Last Period, axisId: last_fact.total_impressions, __FILE: app-marketing-bing-ads/bi_campaign_metrics_impressions.dashboard.lookml,
  ...
  - title: Impressions To Date
    ...
    y_axes: [{label: '', orientation: left, series: [{id: fact.total_conversions,
            name: Conversions, axisId: fact.total_conversions, __FILE: app-marketing-bing-ads/bi_campaign_metrics_impressions.dashboard.lookml,
            __LINE_NUM: 60}], showLabels: true, showValues: true, unpinAxis: false,
        tickDensity: default, tickDensityCustom: 5, type: linear, __FILE: app-marketing-bing-ads/bi_campaign_metrics_impressions.dashboard.lookml,
        __LINE_NUM: 57}, {label: !!null '', orientation: right, series: [{id: fact.average_cost_per_conversion,
            name: Cost per Conversion, axisId: fact.average_cost_per_conversion, __FILE: app-marketing-bing-ads/bi_campaign_metrics_impressions.dashboard.lookml,
        ...
        __LINE_NUM: 73}, {label: !!null '', orientation: right, series: [{id: fact.average_cost_per_click,
            name: Cost per Click, axisId: fact.average_cost_per_click, __FILE: app-marketing-bing-ads/bi_campaign_metrics_impressions.dashboard.lookml,
        ...
        __LINE_NUM: 89}, {label: !!null '', orientation: right, series: [{id: fact.average_conversion_rate,
            name: Conversion Rate, axisId: fact.average_conversion_rate, __FILE: app-marketing-bing-ads/bi_campaign_metrics_impressions.dashboard.lookml,
            __LINE_NUM: 108}, {id: fact.average_click_rate, name: Click Through Rate,
            axisId: fact.average_click_rate, __FILE: app-marketing-bing-ads/bi_campaign_metrics_impressions.dashboard.lookml,
