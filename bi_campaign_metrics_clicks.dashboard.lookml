- dashboard: bing_campaign_metrics_clicks
  ...
  - title: Clicks By Day Of Week
    ...
    y_axes: [{label: '', orientation: bottom, series: [{id: fact.total_clicks, name: Keyword
              This Period Clicks, axisId: fact.total_clicks, __FILE: app-marketing-bing-ads/bi_campaign_metrics_clicks.dashboard.lookml,
            __LINE_NUM: 507}], showLabels: false, showValues: false, unpinAxis: false,
        tickDensity: default, type: linear, __FILE: app-marketing-bing-ads/bi_campaign_metrics_clicks.dashboard.lookml,
        __LINE_NUM: 504}]
  ...
  - title: Clicks By Network
    ...
    y_axes: [{label: '', orientation: bottom, series: [{id: fact.total_clicks, name: Fact
              Clicks, axisId: fact.total_clicks, __FILE: app-marketing-bing-ads/bi_campaign_metrics_clicks.dashboard.lookml,
            __LINE_NUM: 581}], showLabels: false, showValues: false, unpinAxis: false,
        tickDensity: default, type: linear, __FILE: app-marketing-bing-ads/bi_campaign_metrics_clicks.dashboard.lookml,
        __LINE_NUM: 578}]
    show_y_axis_labels: true
    show_y_axis_ticks: true
  ...
  - title: Clicks By Device
    ...
    y_axes: [{label: '', orientation: bottom, series: [{id: fact.total_clicks, name: Clicks,
            axisId: fact.total_clicks, __FILE: app-marketing-bing-ads/bi_campaign_metrics_clicks.dashboard.lookml,
            __LINE_NUM: 655}], showLabels: false, showValues: false, unpinAxis: false,
        tickDensity: default, type: linear, __FILE: app-marketing-bing-ads/bi_campaign_metrics_clicks.dashboard.lookml,
        __LINE_NUM: 652}]
    show_y_axis_labels: true
    show_y_axis_ticks: true
  ...
  - title: Clicks By Bid Strategy
    ...
    y_axes: [{label: '', orientation: bottom, series: [{id: fact.total_clicks, name: Keyword
              This Period Clicks, axisId: fact.total_clicks, __FILE: app-marketing-bing-ads/bi_campaign_metrics_clicks.dashboard.lookml,
            __LINE_NUM: 729}], showLabels: false, showValues: false, unpinAxis: false,
        tickDensity: default, type: linear, __FILE: app-marketing-bing-ads/bi_campaign_metrics_clicks.dashboard.lookml,
        __LINE_NUM: 726}]
    show_y_axis_labels: true
    show_y_axis_ticks: true
  ...
  - title: Creative Clicks Change
    ...
    y_axes: [{label: '', orientation: bottom, series: [{id: last_fact.total_conversions,
            name: Ad Last Period, axisId: last_fact.total_conversions, __FILE: app-marketing-bing-ads/bi_campaign_metrics_clicks.dashboard.lookml,
            __LINE_NUM: 206}, {id: fact.total_conversions, name: Ad This Period, axisId: fact.total_conversions,
            __FILE: app-marketing-bing-ads/bi_campaign_metrics_clicks.dashboard.lookml,
  ...
  - title: Ad Group Clicks Change
    ...
    y_axes: [{label: '', orientation: bottom, series: [{id: fact.total_conversions,
            name: Ad Group This Period, axisId: fact.total_conversions, __FILE: app-marketing-bing-ads/bi_campaign_metrics_clicks.dashboard.lookml,
            __LINE_NUM: 423}, {id: last_fact.total_conversions, name: Ad Group Last
              Period, axisId: last_fact.total_conversions, __FILE: app-marketing-bing-ads/bi_campaign_metrics_clicks.dashboard.lookml,
            __LINE_NUM: 428}], showLabels: true, showValues: false, unpinAxis: false,
        tickDensity: default, type: linear, __FILE: app-marketing-bing-ads/bi_campaign_metrics_clicks.dashboard.lookml,
        __LINE_NUM: 420}]
    show_y_axis_labels: true
    show_y_axis_ticks: true
  ...
  - title: Landing Pages Clicks Change
    ...
    show_view_names: false
    y_axes: [{label: '', orientation: bottom, series: [{id: last_fact.total_conversions,
            name: Keyword Prior Period, axisId: last_fact.total_conversions, __FILE: app-marketing-bing-ads/bi_campaign_metrics_clicks.dashboard.lookml,
            __LINE_NUM: 315}, {id: fact.total_conversions, name: Keyword This Period,
            axisId: fact.total_conversions, __FILE: app-marketing-bing-ads/bi_campaign_metrics_clicks.dashboard.lookml,
            __LINE_NUM: 320}], showLabels: true, showValues: false, unpinAxis: false,
        tickDensity: default, type: linear, __FILE: app-marketing-bing-ads/bi_campaign_metrics_clicks.dashboard.lookml,
        __LINE_NUM: 312}]
    show_y_axis_labels: true
    show_y_axis_ticks: true
  ...
  - title: Clicks To Date
    ...
    y_axes: [{label: '', orientation: left, series: [{id: fact.total_conversions,
            name: Conversions, axisId: fact.total_conversions, __FILE: app-marketing-bing-ads/bi_campaign_metrics_clicks.dashboard.lookml,
            __LINE_NUM: 60}], showLabels: true, showValues: true, unpinAxis: false,
        tickDensity: default, tickDensityCustom: 5, type: linear, __FILE: app-marketing-bing-ads/bi_campaign_metrics_clicks.dashboard.lookml,
        __LINE_NUM: 57}, {label: !!null '', orientation: right, series: [{id: fact.average_cost_per_conversion,
            name: Cost per Conversion, axisId: fact.average_cost_per_conversion, __FILE: app-marketing-bing-ads/bi_campaign_metrics_clicks.dashboard.lookml,
        ...
        __LINE_NUM: 73}, {label: !!null '', orientation: right, series: [{id: fact.average_cost_per_click,
            name: Cost per Click, axisId: fact.average_cost_per_click, __FILE: app-marketing-bing-ads/bi_campaign_metrics_clicks.dashboard.lookml,
        ...
        __LINE_NUM: 89}, {label: !!null '', orientation: right, series: [{id: fact.average_conversion_rate,
            name: Conversion Rate, axisId: fact.average_conversion_rate, __FILE: app-marketing-bing-ads/bi_campaign_metrics_clicks.dashboard.lookml,
            __LINE_NUM: 108}, {id: fact.average_click_rate, name: Click Through Rate,
            axisId: fact.average_click_rate, __FILE: app-marketing-bing-ads/bi_campaign_metrics_clicks.dashboard.lookml,
