- dashboard: bing_campaign_metrics_cost_per_impression
  ...
  - title: Cost Per Impression By Day Of Week
    ...
    y_axes: [{label: '', orientation: bottom, series: [{id: fact.average_cost_per_impression,
            name: Keyword This Period CPM, axisId: fact.average_cost_per_impression,
        ...
        tickDensity: default, type: linear, __FILE: app-marketing-bing-ads/bi_campaign_metrics_cpm.dashboard.lookml,
        __LINE_NUM: 179}]
  ...
  - title: Cost Per Impression By Device
    ...
    y_axes: [{label: '', orientation: bottom, series: [{id: fact.average_cost_per_impression,
            name: CPM, axisId: fact.average_cost_per_impression, __FILE: app-marketing-bing-ads/bi_campaign_metrics_cpm.dashboard.lookml,
            __LINE_NUM: 338}], showLabels: false, showValues: false, unpinAxis: false,
        tickDensity: default, type: linear, __FILE: app-marketing-bing-ads/bi_campaign_metrics_cpm.dashboard.lookml,
        __LINE_NUM: 335}]
    show_y_axis_labels: true
    show_y_axis_ticks: true
  ...
  - title: Cost Per Impression By Network
    ...
    type: looker_bar
    fields: [fact.channel, fact.average_cost_per_impression]
    sorts: [fact.average_cost_per_impression desc]
    limit: 500
    query_timezone: America/Los_Angeles
    x_axis_gridlines: false
    ...
    show_view_names: true
    y_axes: [{label: '', orientation: bottom, series: [{id: fact.average_cost_per_impression,
            name: Fact CPM, axisId: fact.average_cost_per_impression, __FILE: app-marketing-bing-ads/bi_campaign_metrics_cpm.dashboard.lookml,
  ...
  - title: Cost Per Impression By Bid Strategy
    ...
    explore: bing_keyword_date_fact
    type: looker_bar
    fields: [keyword.bid_strategy_type, fact.average_cost_per_impression]
    sorts: [keyword.bid_strategy_type]
    limit: 500
    query_timezone: America/Los_Angeles
    x_axis_gridlines: false
    y_axis_gridlines: false
  ...
  - title: Creative Cost Per Impression Change
    ...
    fields: [ad.title, ad_group.ad_group_name, campaign.campaign_name, last_fact.total_impressions_period_delta,
      last_fact.average_cost_per_impression, fact.average_cost_per_impression]
    filters:
    ...
    y_axes: [{label: '', orientation: bottom, series: [{id: last_fact.average_cost_per_impression,
            name: Ad Last Period, axisId: last_fact.average_cost_per_impression, __FILE: app-marketing-bing-ads/bi_campaign_metrics_cpm.dashboard.lookml,
            __LINE_NUM: 507}, {id: fact.average_cost_per_impression, name: Ad This
              Period, axisId: fact.average_cost_per_impression, __FILE: app-marketing-bing-ads/bi_campaign_metrics_cpm.dashboard.lookml,
  ...
  - title: Landing Pages Cost Per Impression Change
    ...
    explore: bing_keyword_date_fact
    type: looker_bar
    fields: [ad_group.ad_group_name, campaign.campaign_name, keyword.final_url, fact.total_impressions_period_delta,
      last_fact.average_cost_per_impression, fact.average_cost_per_impression]
    filters:
      fact.total_conversions_period_delta_abs: ">0"
    ...
    show_view_names: false
    y_axes: [{label: '', orientation: bottom, series: [{id: last_fact.average_cost_per_impression,
            name: Keyword Prior Period, axisId: last_fact.average_cost_per_impression,
            __FILE: app-marketing-bing-ads/bi_campaign_metrics_cpm.dashboard.lookml,
            __LINE_NUM: 610}, {id: fact.average_cost_per_impression, name: Keyword
              This Period, axisId: fact.average_cost_per_impression, __FILE: app-marketing-bing-ads/bi_campaign_metrics_cpm.dashboard.lookml,
            __LINE_NUM: 613}], showLabels: true, showValues: false, unpinAxis: false,
        tickDensity: default, type: linear, __FILE: app-marketing-bing-ads/bi_campaign_metrics_cpm.dashboard.lookml,
        __LINE_NUM: 607}]
    show_y_axis_labels: true
    show_y_axis_ticks: true
    ...
    conditional_formatting_include_nulls: false
    hidden_fields: [campaign.name, ad_group.ad_group_name, ad_group.ad_group_name,
      campaign.campaign_name, fact.total_impressions_period_delta]
    listen:
      Period: fact.period
      Period Latest: fact.date_period_latest
      Campaign: campaign.campaign_name
  ...
  - title: Ad Group Cost Per Impression Change
    ...
    type: looker_bar
    fields: [campaign.campaign_name, ad_group.ad_group_name, fact.total_impressions_period_delta,
      last_fact.average_cost_per_impression, fact.average_cost_per_impression]
    filters:
      fact.total_conversions_period_delta_abs: ">0"
    sorts: [fact.total_impressions_period_delta desc]
  ...
  - title: Cost Per Impressions To Date
    ...
    y_axes: [{label: '', orientation: left, series: [{id: fact.total_conversions,
            name: Conversions, axisId: fact.total_conversions, __FILE: app-marketing-bing-ads/bi_campaign_metrics_cpm.dashboard.lookml,
            __LINE_NUM: 60}], showLabels: true, showValues: true, unpinAxis: false,
        tickDensity: default, tickDensityCustom: 5, type: linear, __FILE: app-marketing-bing-ads/bi_campaign_metrics_cpm.dashboard.lookml,
        __LINE_NUM: 57}, {label: !!null '', orientation: right, series: [{id: fact.average_cost_per_conversion,
            name: Cost per Conversion, axisId: fact.average_cost_per_conversion, __FILE: app-marketing-bing-ads/bi_campaign_metrics_cpm.dashboard.lookml,
        ...
        __LINE_NUM: 73}, {label: !!null '', orientation: right, series: [{id: fact.average_cost_per_click,
            name: Cost per Click, axisId: fact.average_cost_per_click, __FILE: app-marketing-bing-ads/bi_campaign_metrics_cpm.dashboard.lookml,
        ...
        __LINE_NUM: 89}, {label: !!null '', orientation: right, series: [{id: fact.average_conversion_rate,
            name: Conversion Rate, axisId: fact.average_conversion_rate, __FILE: app-marketing-bing-ads/bi_campaign_metrics_cpm.dashboard.lookml,
            __LINE_NUM: 108}, {id: fact.average_click_rate, name: Click Through Rate,
            axisId: fact.average_click_rate, __FILE: app-marketing-bing-ads/bi_campaign_metrics_cpm.dashboard.lookml,
