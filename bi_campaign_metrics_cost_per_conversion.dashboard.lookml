- dashboard: bing_campaign_metrics_cost_per_conversion
  ...
  - title: Cost Per Conversion By Day Of Week
    ...
    y_axes: [{label: '', orientation: bottom, series: [{id: fact.average_cost_per_conversion,
            name: Keyword This Period Cost, axisId: fact.average_cost_per_conversion,
        ...
        tickDensity: default, tickDensityCustom: 5, type: linear, __FILE: app-marketing-bing-ads/bi_campaign_metrics_cost_per_conversion.dashboard.lookml,
        __LINE_NUM: 30}]
  ...
  - title: Ad Cost Per Conversion Change
    ...
    type: looker_bar
    fields: [ad.title, last_fact.average_cost_per_conversion, fact.average_cost_per_conversion,
      fact.average_cost_per_conversion_period_percent_change, ad_group.ad_group_name,
    ...
    y_axes: [{label: '', maxValue: !!null '', minValue: !!null '', orientation: bottom,
        ...
        type: linear, unpinAxis: false, valueFormat: !!null '', series: [{id: fact.average_cost_per_conversion,
            name: Period Fact, axisId: fact.average_cost_per_conversion, __FILE: app-marketing-bing-ads/bi_campaign_metrics_cost_per_conversion.dashboard.lookml,
            __LINE_NUM: 761}, {id: last_fact.average_cost_per_conversion, name: Last
              Period Fact, axisId: last_fact.average_cost_per_conversion, __FILE: app-marketing-bing-ads/bi_campaign_metrics_cost_per_conversion.dashboard.lookml,
            __LINE_NUM: 766}], __FILE: app-marketing-bing-ads/bi_campaign_metrics_cost_per_conversion.dashboard.lookml,
        __LINE_NUM: 749}]
    show_y_axis_labels: true
    show_y_axis_ticks: true
    y_axis_tick_density: default
    ...
    hidden_fields: [ad_group.ad_group_name, campaign.name, fact.average_cost_per_conversion_period_percent_change,
  ...
  - title: Keyword Cost Per Conversion Change
    ...
    explore: bing_keyword_date_fact
    type: looker_bar
    fields: [keyword.keyword, last_fact.average_cost_per_conversion, fact.average_cost_per_conversion,
    ...
    y_axes: [{label: '', maxValue: !!null '', minValue: !!null '', orientation: bottom,
        ...
        type: linear, unpinAxis: false, valueFormat: !!null '', series: [{id: fact.average_cost_per_conversion,
            name: Period Fact, axisId: fact.average_cost_per_conversion, __FILE: app-marketing-bing-ads/bi_campaign_metrics_cost_per_conversion.dashboard.lookml,
            __LINE_NUM: 643}, {id: last_fact.average_cost_per_conversion, name: Last
              Period Fact, axisId: last_fact.average_cost_per_conversion, __FILE: app-marketing-bing-ads/bi_campaign_metrics_cost_per_conversion.dashboard.lookml,
            __LINE_NUM: 648}], __FILE: app-marketing-bing-ads/bi_campaign_metrics_cost_per_conversion.dashboard.lookml,
        __LINE_NUM: 631}]
    show_y_axis_labels: true
    show_y_axis_ticks: true
    y_axis_tick_density: default
    ...
    y_axes: [{label: '', maxValue: !!null '', minValue: !!null '', orientation: bottom,
        ...
        type: linear, unpinAxis: false, valueFormat: !!null '', series: [{id: fact.average_cost_per_conversion,
            ...
            __LINE_NUM: 524}, {id: last_fact.average_cost_per_conversion, name: Last
              Period Fact, axisId: last_fact.average_cost_per_conversion, __FILE: app-marketing-bing-ads/bi_campaign_metrics_cost_per_conversion.dashboard.lookml,
            __LINE_NUM: 529}], __FILE: app-marketing-bing-ads/bi_campaign_metrics_cost_per_conversion.dashboard.lookml,
        __LINE_NUM: 512}]
    show_y_axis_labels: true
    show_y_axis_ticks: true
    y_axis_tick_density: default
  ...
  - title: Cost Per Conversion By Bid Strategy
    ...
    explore: bing_keyword_date_fact
    type: looker_bar
    fields: [keyword.bid_strategy_type, fact.average_cost_per_conversion]
    sorts: [fact.average_cost_per_conversion desc]
    limit: 500
    query_timezone: America/Los_Angeles
    x_axis_gridlines: false
  ...
  - title: Cost Per Conversion By Device
    ...
    explore: bing_ad_date_fact
    type: looker_bar
    fields: [fact.device_type, fact.average_cost_per_conversion]
    sorts: [fact.average_cost_per_conversion desc]
    limit: 500
    query_timezone: America/Los_Angeles
    x_axis_gridlines: false
    ...
    show_view_names: false
    y_axes: [{label: '', orientation: bottom, series: [{id: fact.average_cost_per_conversion,
            name: Cost, axisId: fact.average_cost_per_conversion, __FILE: app-marketing-bing-ads/bi_campaign_metrics_cost_per_conversion.dashboard.lookml,
  ...
  - title: Cost Per Conversion By Network
    ...
    type: looker_bar
    fields: [fact.channel, fact.average_cost_per_conversion]
    sorts: [fact.average_cost_per_conversion desc]
    limit: 500
    query_timezone: America/Los_Angeles
    x_axis_gridlines: false
    ...
    show_view_names: true
    y_axes: [{label: '', orientation: bottom, series: [{id: fact.average_cost_per_conversion,
            name: Fact Cost, axisId: fact.average_cost_per_conversion, __FILE: app-marketing-bing-ads/bi_campaign_metrics_cost_per_conversion.dashboard.lookml,
  ...
  - title: Cost Per Conversion To Date
    ...
    y_axis_gridlines: true
    show_view_names: false
    y_axes: [{label: '', orientation: left, series: [{id: fact.average_cost_per_conversion,
            name: Cost Per Conversion, axisId: fact.average_cost_per_conversion, __FILE: app-marketing-bing-ads/bi_campaign_metrics_cost_per_conversion.dashboard.lookml,
        ...
        __LINE_NUM: 376}, {label: !!null '', orientation: right, series: [{id: fact.average_cost_per_click,
            name: Cost per Click, axisId: fact.average_cost_per_click, __FILE: app-marketing-bing-ads/bi_campaign_metrics_cost_per_conversion.dashboard.lookml,
        ...
        __LINE_NUM: 392}, {label: !!null '', orientation: right, series: [{id: fact.average_conversion_rate,
            name: Conversion Rate, axisId: fact.average_conversion_rate, __FILE: app-marketing-bing-ads/bi_campaign_metrics_cost_per_conversion.dashboard.lookml,
            __LINE_NUM: 411}, {id: fact.average_click_rate, name: Click Through Rate,
            axisId: fact.average_click_rate, __FILE: app-marketing-bing-ads/bi_campaign_metrics_cost_per_conversion.dashboard.lookml,
