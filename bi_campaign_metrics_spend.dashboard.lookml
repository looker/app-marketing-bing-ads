- dashboard: bing_campaign_metrics_spend
  ...
  - title: Spend By Day Of Week
    ...
    y_axes: [{label: '', orientation: bottom, series: [{id: fact.total_cost, name: Keyword
              This Period Cost, axisId: fact.total_cost, __FILE: block-bing-ads/bing_ads_spend.dashboard.lookml,
            __LINE_NUM: 102}], showLabels: false, showValues: false, unpinAxis: false,
        tickDensity: default, tickDensityCustom: 5, type: linear, __FILE: block-bing-ads/bing_ads_spend.dashboard.lookml,
        __LINE_NUM: 99}]
    show_y_axis_labels: true
    show_y_axis_ticks: true
    y_axis_tick_density: default
  ...
  - title: Spend By Network
    ...
    y_axes: [{label: '', orientation: bottom, series: [{id: fact.total_cost, name: Fact
              Cost, axisId: fact.total_cost, __FILE: block-bing-ads/bing_ads_spend.dashboard.lookml,
  ...
  - title: Spend By Device
    ...
    y_axes: [{label: '', orientation: bottom, series: [{id: fact.total_cost, name: Cost,
            axisId: fact.total_cost, __FILE: block-bing-ads/bing_ads_spend.dashboard.lookml,
  ...
  - title: Ad Spend Change
    ...
    y_axes: [{label: '', maxValue: !!null '', minValue: !!null '', orientation: bottom,
        ...
        type: linear, unpinAxis: false, valueFormat: !!null '', series: [{id: fact.total_cost,
            name: Cost, axisId: fact.total_cost, __FILE: block-bing-ads/bing_ads_spend.dashboard.lookml,
            __LINE_NUM: 452}], __FILE: block-bing-ads/bing_ads_spend.dashboard.lookml,
        __LINE_NUM: 440}]
    show_y_axis_labels: true
    show_y_axis_ticks: true
    y_axis_tick_density: default
  ...
  - title: Keyword Spend Change
    ...
    y_axes: [{label: '', maxValue: !!null '', minValue: !!null '', orientation: bottom,
        ...
        type: linear, unpinAxis: false, valueFormat: !!null '', series: [{id: fact.total_cost,
            name: Cost, axisId: fact.total_cost, __FILE: block-bing-ads/bing_ads_spend.dashboard.lookml,
            __LINE_NUM: 571}], __FILE: block-bing-ads/bing_ads_spend.dashboard.lookml,
        __LINE_NUM: 559}]
    show_y_axis_labels: true
    show_y_axis_ticks: true
    y_axis_tick_density: default
  ...
  - title: Landing Pages Spend Change
    ...
    y_axes: [{label: '', maxValue: !!null '', minValue: !!null '', orientation: bottom,
        ...
        type: linear, unpinAxis: false, valueFormat: !!null '', series: [{id: fact.total_cost,
            name: Cost, axisId: fact.total_cost, __FILE: block-bing-ads/bing_ads_spend.dashboard.lookml,
            __LINE_NUM: 675}], __FILE: block-bing-ads/bing_ads_spend.dashboard.lookml,
        __LINE_NUM: 663}]
    show_y_axis_labels: true
    show_y_axis_ticks: true
    y_axis_tick_density: default
    ...
    point_style: none
    series_colors:
      last_fact.total_cost: "#4bb86a"
      fact.total_cost: "#90eb94"
    show_value_labels: true
    label_density: 25
    x_axis_scale: auto
    y_axis_combined: true
